...
| Brockston      | 7777  | Educator backend (chat, file ops, suggest)  |
...
# Terminal 2
python -m uvicorn backend.launcher:app --port 7777            # port 7777
...
| `BROCKSTON_PORT`     | `7777`                        | Brockston educator port                |
