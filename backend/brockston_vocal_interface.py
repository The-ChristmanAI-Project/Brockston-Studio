...
try:
    from brockston_brain import BROCKSTON as BrockstonBrain # pyright: ignore[reportMissingImports]
...
try:
    from json_guardian import JSONGuardian # pyright: ignore[reportMissingImports]
...
class BrockstonUltimateVoice:
    ...
    def _initialize_ai_providers(self, provider):
        ...
        self.ai_clients = {}
        try:
            from brockston_api_client import anthropic_client
    ...
    def _initialize_brain(self):
        ...
        try:
            ...
            from backend.tone_manager import ToneManager
            from backend.emotion import analyze_emotion  # Fixed: was emotion_tagging
            from backend.local_reasoning_engine import LocalReasoningEngine
            ...
            if VISION_ENABLED:
                try:
                    from backend.simple_vision_engine import SimpleVisionEngine
        ...
        try:
            from backend.proactive_intelligence import ProactiveIntelligence
        ...
        try:
            from backend.autonomous_learning_engine import EnhancedAutonomousLearningEngine
