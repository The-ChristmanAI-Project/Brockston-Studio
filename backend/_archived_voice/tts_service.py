...
# Define available voices directly to avoid circular import
AVAILABLE_VOICES = [
    {"id": "calming", "label": "Calming Voice", "tld": "com", "gender": "female"},
    {"id": "us_male", "label": "US Male", "tld": "us", "gender": "male"},
    {"id": "uk_female", "label": "UK Female", "tld": "co.uk", "gender": "female"},
    {"id": "casual", "label": "Casual Voice", "tld": "ca", "gender": "neutral"},
    {"id": "formal", "label": "Formal Voice", "tld": "co.in", "gender": "neutral"},
    {"id": "friendly_male", "label": "Friendly Male", "tld": "ie", "gender": "male"},
    {"id": "za_voice", "label": "South African", "tld": "co.za", "gender": "neutral"},
    {
        "id": "au_female",
...
def text_to_speech(
    ...
    """Generate speech from text using gTTS with voice profiles.

    Args:
        text: Text to convert to speech
        voice_id: Voice profile identifier (defaults to 'calming')
